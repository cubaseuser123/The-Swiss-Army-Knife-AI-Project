        ...
        <div className="flex min-h-screen items-center justify-center p-4 text-landing-text-main selection:bg-landing-primary selection:text-landing-surface relative overflow-hidden">
            ...
            <Card className="w-full max-w-md bg-landing-surface border-2 border-landing-text-main shadow-[8px_8px_0px_0px_#121212] relative z-10">
                <CardHeader className="text-center space-y-2">
                    <CardTitle className="text-3xl font-display font-bold text-landing-text-main">Sign Up</CardTitle>
                    <CardDescription className="text-landing-text-muted font-body">Create your Swiss Army Knife AI account</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="name" className="font-display font-bold">Name</Label>
                            <Input
                                id="name"
                                type="text"
                                value={name}
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                className="bg-landing-background border-landing-border focus:ring-landing-primary font-mono-custom"
                            />
                            <p className="text-xs text-landing-text-muted font-mono-custom">Must be at least 8 characters</p>
                        </div>
                ...
                <CardFooter className="justify-center border-t border-landing-border/20 pt-6">
                    <p className="text-sm text-landing-text-muted font-mono-custom">
                        ...
                        <Link href="/sign-in" className="text-landing-primary hover:text-landing-text-main font-bold hover:underline transition-colors">Sign in</Link>
                    </p>
                </CardFooter>
            </Card>
        </div>
